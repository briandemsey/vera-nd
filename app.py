...
def check_password():
    ...
    <div style="text-align: center; padding: 60px 20px;">
        <h1 style="color: {ND_BLUE}; font-size: 3rem; margin-bottom: 10px;">VERA-ND</h1>
        <p style="color: #666; font-size: 1.1rem; margin-bottom: 40px;">
            Verification Engine for Results &amp; Accountability<br>North Dakota Implementation
        </p>
    </div>
    ...
    with col2:
        ...
        if st.button("Access VERA-ND", use_container_width=True):
    ...
    <div style="text-align: center; margin-top: 60px; color: #999; font-size: 0.85rem;">
        <p>VERA-ND analyzes ACCESS for ELLs domain data and ND A+ results across ~168 North Dakota districts.</p>
        <p>~4,100 English Learners | Fargo/West Fargo = ~60% of state ELs | New 2025 cut scores</p>
        <p>Somali/Nepali refugee resettlement | Oil boom immigrant populations</p>
